...
git clone git@github.com:bmfe/eros-plugin-android-getui.git "erosplugingt" 

git clone git@github.com:bmfe/eros-plugin-android-wxpay.git "erospluginwxpay" 

git clone git@github.com:bmfe/eros-plugin-android-wxshare.git "erospluginumeng" 
cd ../
